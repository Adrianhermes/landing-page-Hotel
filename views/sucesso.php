...
<div class="container-home" style="max-width: 500px; margin: 60px auto;">
  <div class="card" style="padding: 32px; text-align: center;">
    ...
    <div>
      <a href="/hotel/views/gerenciarQuarto.php" class="btn btn-primary" style="margin-right: 8px;">Ver Quartos</a>
      <a href="/hotel/views/quarto.php" class="btn btn-success">Cadastrar Novo</a>
    </div>
  </div>
</div>
