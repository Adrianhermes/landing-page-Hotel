<footer class="footer">
  <div class="footer-container">
    <div class="newsletter-row">
      ...
      <form class="newsletter-form-horizontal">
        <input id="newsletter" placeholder="DIGITE SEU EMAIL" required>
        <button type="submit">ENVIAR <span>&rarr;</span></button>
      </form>
    </div>

    <div class="newsletter-bar"></div>
    ...
    <div class="footer-columns">
      ...
      <div class="footer-box footer-acomodacoes">
        <h4>ACOMODA&Ccedil;&Otilde;ES</h4>
        <ul>
  ...
  <div id="newsletter-modal" class="modal">
    <div class="modal-content">
      <span class="close" data-modal-close="newsletter-modal">&times;</span>
      <p id="modal-message"></p>
    </div>
  </div>

  <div class="copyright">
    &copy; 2025 Essentia. Designed By Adrian Hermes.
  </div>
</footer>
