...
2. Banco de Dados:
  ...
  - Importe o esquema SQL em anexo e conforme descrito acima.

3. Configurações:
  - Edite config/conexao.php com suas credenciais de banco.

4. Acesso:
  - Front público: http://localhost/hotel/index.php
  - Painel admin: http://localhost/hotel/views/login.php

5. Dados iniciais:
  - Crie um usuário admin com senha gerada por password_hash().
  - Cadastre quartos para ativar reservas.
